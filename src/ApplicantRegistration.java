...
public class ApplicantRegistration extends JFrame {
	...
	public ApplicantRegistration() {
     ...
     // TextField =================================================================================
        ...
        // REGISTER btn
        btnRegister = new JButton(new ImageIcon("Buttons/ApplicantRegistration/RegisterBtn1.png"));
        btnRegister.setBorder(null);
        btnRegister.setBounds(1015, 86, 104, 36);
        contentPane.add(btnRegister);

        // APPLICANT LOGIN
        btnLogIn = new JButton(new ImageIcon("Buttons/ApplicantRegistration/LoginBtn.png"));
        ...
        // ADMIN LOGIN
        btnAdmin = new JButton(new ImageIcon("Buttons/ApplicantRegistration/AdminBtn.png"));
        ...
        // ADD BUTTON
        btnAdd = new JButton(new ImageIcon("C:/Users/menes/Downloads/NCVA_UI_Testing/Buttons/ApplicantRegistration/btnAdd.png"));
        ...
        // CLEAR BUTTON
        btnClear = new JButton(new ImageIcon("Buttons/ApplicantRegistration/btnClear.png"));
        ...
        JLabel lbl_AdminLogBG = new JLabel(new ImageIcon("Pages/ApplicantRegistration.png"));
