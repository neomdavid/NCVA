...
public class AdminLogin extends JFrame {
    ...
    public AdminLogin() {
        ...
        btn_Login = new JButton(new ImageIcon("Buttons/AdminLogin/SIGN_IN(ADMIN).png"));
        ...
        //LOGIN PAGE (USER)
        BackButton = new JButton(new ImageIcon("Buttons/HomePage/LoginBtn.png"));
        ...
        JLabel lbl_AdminLogBG = new JLabel(new ImageIcon("Pages/ADMIN LOGIN(1).png"));
